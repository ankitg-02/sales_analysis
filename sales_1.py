{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNLqSM9wzRm4yiiXJOIevCZ",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/ankitg-02/data_analysis/blob/main/sales_1.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "b8GFykAJ4f6d",
        "outputId": "7de6c9ca-8e64-476d-bf4b-082405dbea62"
      },
      "execution_count": 8,
      "outputs": [
        {
    ...
    },
    {
      ...
      "source": [
        ...
        "  if i=='Consumer':\n",
        "    count_of_consumer+=1\n",
        "print(\"count_of_consumer=\",count_of_consumer)\n",
        "count_of_corporate=0\n",
        "for j in sales['Segment']:\n",
        "  if j=='Corporate':\n",
        "    count_of_corporate+=1\n",
        "print(\"count_of_corporate=\",count_of_corporate)\n",
        "count_of_home_office=0\n",
        "for  k in sales['Segment']:\n",
        "  if k=='Home Office':\n",
        "    count_of_home_office+=1\n",
        "print(\"count_of_home_office=\",count_of_home_office)\n"
      ],
      "metadata": {
        "colab": {
          "base_uri": "https://localhost:8080/"
        ...
        "id": "GbV_nB804k74",
        "outputId": "cab90bd9-dc56-4abc-e2bf-ab2dba39b49d"
      },
      "execution_count": 11,
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "count_of_consumer= 5191\n",
            "count_of_corporate= 3020\n",
            "count_of_home_office= 1783\n"
          ]
        }
      ]
    },
    {
      "cell_type": "code",
      "source": [
        "max_of_segement=max(count_of_consumer,count_of_corporate,count_of_home_office)\n",
        "print(\"max section of segment=\",max_of_segement)"
      ],
      "metadata": {
        "id": "Gm1wKu1L6z97",
        "outputId": "24c3d873-89a7-4536-ffa2-e58d6bb069f2",
        "colab": {
          "base_uri": "https://localhost:8080/"
        }
      },
